...
import 'package:stride/view_model/movement_view_model.dart' show MovesenseViewModel;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.vm.deviceId != null)
              Text('Connected: ${widget.vm.deviceName ?? widget.vm.deviceId}')
            else
              const Text('No device connected'),
            const SizedBox(height: 8),
            ElevatedButton(
              onPressed: () async {
                await widget.vm.startScan();
                setState(() {});
              },
